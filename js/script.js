...
link.addEventListener("click", function (evt) {
    ...
    if (storage) {   // Если значение существует, записываем логин в соответствующее поле ввода при открытии модального окна. из localStorage соответственно
        ...
        email.value = storage;
        letter.focus(); // почему-то не работает, когда заполнены первые два поля, фокус на username, хотя если в следующую строку подставить letter то фокусируется. автозаполнение мешает?
    } else {
